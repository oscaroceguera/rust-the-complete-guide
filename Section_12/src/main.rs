...
fn check_invetory(items: Vec<Item>, product: String) -> Vec<Item> {
...
fn main() {
    ...
    // let num = example(2); // Error because at the first time we insert a string

    // Fn, FnMut and FnOnce
    // Fn multiple times, includes all fn functions
    ...
    // let y = 5;
    // let add_y = |x| x + y;
    // let copy = add_y; // this is closure beign copied
    ...
    //     y
    // };
    // let mut copy = add_y; // this is closure beign copied
    // println!("{}", add_y(copy(10)));
    ...
    let checked = check_invetory(vec, String::from("shirt"));
    println!("{:?}", checked);
